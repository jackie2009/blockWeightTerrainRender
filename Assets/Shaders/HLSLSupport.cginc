...
//@Wooduan("configurable deferred gbuffer") BEGIN
//#define EXTRA_DEFERRED_GBUFFER_ENABLED

//#if defined(EXTRA_DEFERRED_GBUFFER_ENABLED)
#define SHADOW_MASK_TARGET_SLOT 4

#define DEFERRED_FRAG_SIGNATURE_GBUFFER \
    , out half4 outGBuffer0 : SV_Target0 \
    , out half4 outGBuffer1 : SV_Target1 \
    , out half4 outGBuffer2 : SV_Target2

#define DEFERRED_FRAG_SIGNATURE_EMISSION \
    , out half4 outEmission : SV_Target3

#define DEFERRED_FRAG_SIGNATURE_SHADOWMASK \
    , out half4 outShadowMask : SV_Target4
        
// #else
// #define SHADOW_MASK_TARGET_SLOT 3
...
// #define DEFERRED_FRAG_SIGNATURE_EMISSION \
//     , out half4 outEmission : SV_Target2

// #define DEFERRED_FRAG_SIGNATURE_SHADOWMASK \
//     , out half4 outShadowMask : SV_Target3

// #endif
//@Wooduan("configurable deferred gbuffer") END
